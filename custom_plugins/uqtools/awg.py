...
class ProgramAWGParametric(ProgramAWG):
    ...
    def __init__(self, awgs, seq_func, seq_kwargs={}, cache=True, wait=True, **kwargs):
        '''
        Program a sequence generated by seq_func on awgs.
        ...
        Input:
            ...
            seq_kwargs - keyword arguments passed to sequence generator function
                ...
                value.get() before being passed to seq_func.
            cache (bool) - If cache is True, the evaluated values in seq_kwargs
                are be compared to previous iterations to determine whether a
                previously exported sequence can be reused.
                You must set cache=False if seq_func depends on any parameters
                not listed in seq_kwargs.
        '''
